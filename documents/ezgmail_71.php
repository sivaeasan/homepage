...
$re_upfields = array();
$re_fields = array();
$field_labels = array("Name"=>"Name","Address"=>"Address","Place"=>"Place","Phone"=>"Phone","Email"=>"Email","C_STATE"=>"C_STATE","Country"=>"Country");
...
$subject = "";
$submit_url = "../documents/72.html";
$error_url = "../documents/73.html";
