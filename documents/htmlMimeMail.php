...
* Last Modified..: $Date: 2006/01/03 13:14:10 $
* CVS Revision...: $Revision: 1.4.1 $
...
*/
	function &_addTextPart(&$obj, $text)
	{
		...
		if (is_object($obj)) {
           $tmp =& $obj->addSubpart($text, $params);
           return $tmp;   //miro
		} else {
			$tmp =& new Mail_mimePart($text, $params);       //miro return new Mail_mimePart($text, $params);
            return $tmp;
		}
	}
...
*/
	function &_addHtmlPart(&$obj)
	{
		...
		if (is_object($obj)) {
			$tmp =& $obj->addSubpart($this->html, $params);
            return $tmp;
		} else {
			$tmp =& new Mail_mimePart($this->html, $params);     //miro return new Mail_mimePart($this->html, $params);
            return $tmp;
		}
	}
...
*/
	function &_addMixedPart()
	{
		...
		$tmp =& new Mail_mimePart('', $params);//miro return new Mail_mimePart('', $params);
        return $tmp;
	}
...
*/
	function &_addHtmlImagePart(&$obj, $value)
	{
		...
		$tmp =& $obj->addSubpart($value['body'], $params);       //miro
        return $tmp;
	}
