...
$re_upfields = array();
$re_fields = array('Name','Address','City');
$field_labels = array("Name"=>"Name","Name"=>"Name","Address"=>"Notes","City"=>"City","Phone"=>"Phone","Email"=>"Email","Country"=>"Country");
...
$subject = "";
$submit_url = "../documents/62.html";
$error_url = "../documents/63.html";
