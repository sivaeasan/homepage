...
$re_upfields = array();
$re_fields = array();
$field_labels = array("Name"=>"Name","Address"=>"Address","Place"=>"Place","Phone"=>"Phone","Email"=>"Email","Country"=>"Country");
...
$subject = "";
$submit_url = "../documents/65.html";
$error_url = "../documents/66.html";
$emailnotvalid_message = "Please specify valid Email address";
...
$valdontmatch_message = "Validation error";
$reply_enabled = 0;
$reply_url = '';
$reply_images_path = '';
$main_message = <<<MSG
